...
| `builder_guard` | Pre · Edit·Write | 일상용 `dh.cmd`가 설정한 Builder-first 세션에서 HANDOFF/RESULT/INPUT/ADR 외 Claude 직접 edit 차단 → Codex dispatch 유도. raw `claude` escape 세션에서는 inert | ADR-0008 |
