...
# Codex 0.147.0 sends file edits as tool_name="apply_patch" with the patch body in
# (re-verified 2026-08-10 against codex-cli 0.147.0 — see CODEX-COVERAGE.md §6.3)
