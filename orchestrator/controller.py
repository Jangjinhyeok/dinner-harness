...
def build_prompt(handoff_text: str, handoff_name: str) -> str:
    return (
        ...
        "A `HIGH` tier gate does not mean stop and ask before implementing — implement it now and leave it unmerged; the human sign-off happens later in the dispatching session.\n"
